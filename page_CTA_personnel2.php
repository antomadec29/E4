...
while($donnees = mysql_fetch_assoc($reponse2, MYSQL_BOTH)){
	...
	echo "<td width=55%>".$donnees['0']."</td><td width=55%>".$donnees['1']."</td><td><a href='page_CTA_personnel_modifier.php?id=$donnees[2]'><img src='edit.png' /></a></td><td><a href='page_CTA_personnel_supression.php'><img src='delete.png' /></a></td>";
 ...
 ?>
    ...
    <input id="annuler" name="annuler" type="button" value="Annuler" onclick="self.location.href='page_CTA_personnel.php'">
