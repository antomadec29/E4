...
<body>
    ...
    <form method="link" action="page_SP_telephone.php"> <input type="submit" value="Téléphones" /></form>
    <form method="link" action="page_SP_formation.php"> <input type="submit" value="Formations" /></form>
