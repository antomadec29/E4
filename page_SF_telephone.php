...
<body>
	...
	<form id="formulaire" action="page_SF_telephone_2.php" method="get">
    ...
    <p>
        ...
        <input id="effacer" name="effacer" type="reset" value="Annuler" title="" onclick="self.location.href='page_SF_personnel.php'"/>
    </p>
